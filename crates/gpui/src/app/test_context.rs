...
impl VisualTestContext {
    ...
    where
        E: Element,
    {
        self.update_window(self.window, |_, window, cx: &mut WindowContext| {
            ...
            cx.with_absolute_element_offset(origin, |cx| element.prepaint(window, cx));
