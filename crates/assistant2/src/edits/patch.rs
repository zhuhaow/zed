...
use crate::edits::code_edits_tool::CodeEditsToolInput;

use super::code_edits_tool;
...
impl AssistantPatch {
    pub fn from_tool_use(input: &str) -> Result<Self> {
        let input: CodeEditsToolInput = serde_json::from_str(input)?;
        ...
        let edits = input
            ...
            .map(|edit| AssistantEdit {
                path: edit.path,
                kind: match edit.operation {
                    code_edits_tool::Operation::Update {
                        old_text,
                        new_text,
                        description,
                    ...
                    code_edits_tool::Operation::InsertBefore {
                        old_text,
                        new_text,
                        description,
                    ...
                    code_edits_tool::Operation::InsertAfter {
                        old_text,
                        new_text,
                        description,
                    ...
                    code_edits_tool::Operation::Create {
                        description,
                        new_text,
                    ...
                    code_edits_tool::Operation::Delete { old_text } => {
        ...
        Ok(Self {
            ...
            // TODO: In Assistant1 it seems the `range` corresponded to the
            // source range in the context editor, so we might not need it
            // anymore.
